...
".container { background: var(--container-bg); border: 2px solid var(--border-color); padding: 2.5rem 2rem; border-radius: 24px; box-shadow: 0 0 30px rgba(139, 92, 246, 0.15), 0 15px 50px rgba(0, 0, 0, 0.8), inset 0 0 15px rgba(139, 92, 246, 0.1); backdrop-filter: blur(20px); width: 100%; max-width: 480px; text-align: center; position: relative; z-index: 10; transition: filter 0.4s ease, transform 0.4s ease; }"
