...
".container { background: var(--container-bg); border: 1px solid var(--border-color); padding: 3rem 2.5rem; border-radius: 24px; box-shadow: 0 20px 50px rgba(0, 0, 0, 0.5); backdrop-filter: blur(16px); width: 480px; text-align: center; }"
...
".option-card { background: rgba(255, 255, 255, 0.02); border: 1.5px solid rgba(255, 255, 255, 0.05); border-radius: 14px; padding: 1.2rem; text-align: left; cursor: pointer; transition: all 0.25s; display: flex; align-items: center; gap: 1.2rem; position: relative; overflow: hidden; }"
".option-card::before { content: ''; position: absolute; top: 0; left: 0; width: 4px; height: 100%; background: transparent; transition: background-color 0.25s; }"
".option-card:hover { background: rgba(255, 255, 255, 0.04); border-color: rgba(129, 140, 248, 0.25); transform: translateY(-2px); }"
".option-card.active { background: rgba(99, 102, 241, 0.07); border-color: #6366f1; box-shadow: 0 0 20px rgba(99, 102, 241, 0.15); }"
".option-card.active::before { background: #6366f1; }"
".icon-wrapper { background: rgba(255, 255, 255, 0.04); border-radius: 10px; width: 44px; height: 44px; display: flex; align-items: center; justify-content: center; flex-shrink: 0; }"
".option-card.active .icon-wrapper { background: rgba(99, 102, 241, 0.15); }"
".icon-wrapper svg { width: 22px; height: 22px; stroke: var(--text-secondary); stroke-width: 1.5; fill: none; }"
".option-card.active .icon-wrapper svg { stroke: #a5b4fc; }"
".option-info { display: flex; flex-direction: column; }"
".option-title { font-size: 0.95rem; font-weight: 600; color: var(--text-primary); margin-bottom: 0.2rem; }"
".option-desc { font-size: 0.8rem; color: var(--text-secondary); font-weight: 300; }"
".upload-box { border: 2px dashed rgba(255, 255, 255, 0.12); border-radius: 16px; padding: 2.2rem 1rem; margin-bottom: 2rem; cursor: pointer; transition: all 0.3s; display: flex; flex-direction: column; align-items: center; }"
".upload-box:hover { border-color: #6366f1; background: rgba(99, 102, 241, 0.03); }"
".upload-box svg { width: 42px; height: 42px; fill: none; stroke: var(--text-secondary); stroke-width: 1.5; margin-bottom: 0.8rem; }"
".upload-box:hover svg { stroke: #6366f1; }"
"#uploadText { font-size: 0.9rem; color: var(--text-secondary); }"
".btn { background: linear-gradient(135deg, #6366f1, #4f46e5); color: white; border: none; padding: 0.9rem 1.5rem; border-radius: 12px; font-weight: 600; font-size: 0.95rem; font-family: 'Outfit', sans-serif; cursor: pointer; width: 100%; transition: all 0.2s; box-shadow: 0 4px 12px rgba(99, 102, 241, 0.2); }"
".btn:hover { opacity: 0.95; transform: translateY(-1px); box-shadow: 0 6px 20px rgba(99, 102, 241, 0.35); }"
".progress-wrapper { display: none; margin-top: 2rem; text-align: left; }"
".progress-title-wrapper { display: flex; justify-content: space-between; align-items: center; font-size: 0.85rem; }"
".progress-bar { background: rgba(255, 255, 255, 0.06); border-radius: 9999px; height: 6px; overflow: hidden; margin-top: 0.6rem; }"
".progress-fill { background: linear-gradient(90deg, #3b82f6, #8b5cf6); width: 0%; height: 100%; transition: width 0.1s ease; }"
".status-text { font-size: 0.8rem; color: var(--text-secondary); margin-top: 0.4rem; display: flex; justify-content: space-between; }"
"</style>"
"</head>"
"<body>"
"<div class='container'>"
