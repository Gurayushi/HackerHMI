...
"  --neon-blue: #3b82f6;"
"}"
"body { font-family: 'Outfit', sans-serif; background-color: var(--bg-color); color: var(--text-primary); display: flex; flex-direction: column; align-items: center; justify-content: center; min-height: 100vh; margin: 0; overflow-x: hidden; background-image: radial-gradient(circle at 10% 20%, rgba(139, 92, 246, 0.12) 0%, transparent 40%), radial-gradient(circle at 90% 80%, rgba(188, 57, 250, 0.12) 0%, transparent 40%); }"
".container { background: var(--container-bg); border: 2px solid var(--border-color); padding: 3rem 2.5rem; border-radius: 24px; box-shadow: 0 0 30px rgba(139, 92, 246, 0.15), 0 15px 50px rgba(0, 0, 0, 0.8), inset 0 0 15px rgba(139, 92, 246, 0.1); backdrop-filter: blur(20px); width: 480px; text-align: center; position: relative; z-index: 10; transition: filter 0.4s ease, transform 0.4s ease; }"
...
".container.blurred { filter: blur(10px) brightness(0.6); pointer-events: none; transform: scale(0.98); }"
...
"#uploadText { font-size: 0.9rem; color: #9ca3af; font-weight: 400; transition: all 0.3s; }"
...
".modal-overlay { position: fixed; top: 0; left: 0; width: 100vw; height: 100vh; background: rgba(3, 3, 7, 0.75); backdrop-filter: blur(12px); -webkit-backdrop-filter: blur(12px); display: flex; align-items: center; justify-content: center; z-index: 100; opacity: 0; pointer-events: none; transition: opacity 0.4s ease; }"
".modal-overlay.active { opacity: 1; pointer-events: auto; }"
".modal-card { background: rgba(12, 12, 22, 0.95); border: 2px solid var(--accent-neon); border-radius: 24px; padding: 2.2rem 2rem; width: 440px; box-shadow: 0 0 50px rgba(188, 57, 250, 0.4), 0 20px 60px rgba(0, 0, 0, 0.9); transform: scale(0.85); transition: transform 0.4s cubic-bezier(0.175, 0.885, 0.32, 1.275); text-align: left; }"
