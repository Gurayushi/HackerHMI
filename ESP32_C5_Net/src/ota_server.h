...
".container { background: var(--container-bg); border: 2px solid var(--border-color); padding: 3rem 2.5rem; border-radius: 24px; box-shadow: 0 0 30px rgba(139, 92, 246, 0.15), 0 15px 50px rgba(0, 0, 0, 0.8), inset 0 0 15px rgba(139, 92, 246, 0.1); backdrop-filter: blur(20px); width: 100%; max-width: 480px; text-align: center; position: relative; z-index: 10; transition: filter 0.4s ease, transform 0.4s ease; }"
...
".modal-card { background: rgba(12, 12, 22, 0.95); border: 2px solid var(--accent-neon); border-radius: 24px; padding: 2rem 1.5rem; width: 90%; max-width: 440px; box-shadow: 0 0 50px rgba(188, 57, 250, 0.4), 0 20px 60px rgba(0, 0, 0, 0.9); transform: scale(0.85); transition: transform 0.4s cubic-bezier(0.175, 0.885, 0.32, 1.275); text-align: left; }"
