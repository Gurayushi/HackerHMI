...
Powered by the bleeding-edge **Raspberry Pi RP2350** for graphics/PIO manipulation and the **ESP32-C5** for stealthy networking, this 7-inch DWIN touchscreen device is built for system administrators and hardware hackers alike.

## 🔥 Key Features

*   **Asymmetric Brains:** Dual-MCU architecture. RP2350 handles the UI, ANSI Terminal Emulation, and hardware modules. ESP32-C5 manages Wi-Fi 6, Tailscale VPN routing, and libssh2 connections.
...
*   **Network Co-Processor:** ESP32-C5-DevKitC
